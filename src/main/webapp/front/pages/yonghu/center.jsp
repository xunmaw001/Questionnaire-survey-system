		...
		<div id="app">
			...
			<div id="center-container">
				...
				<div :style='{"width":"100%","padding":"0px","margin":"0","background":"none","flex":"1"}' class="right-container">
					<form :style='{"padding":"60px 20px 60px 50%","boxShadow":"0px 0,px 0px #eee","borderColor":"#e6a4b4","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230206/de4c50b5282f45f8a59707bce3185db8.png) no-repeat left bottom / 20%,url(http://codegen.caihongy.cn/20230206/5e80378b411c4449a860d66e35c5c969.png) no-repeat right top / 20%","borderWidth":"0px","display":"block","width":"100%","borderStyle":"outset","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						<!-- 主键 -->
						...
						<div class="layui-form-item" :style='{"padding":"10px","margin":"0 0 0px 0","borderColor":"#efe4d4","borderWidth":"0 0  0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							...
							<button :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0","borderColor":"#eee","color":"#333","outline":"none","borderRadius":"30px","background":"#fff","borderWidth":"1px","width":"auto","fontSize":"14px","lineHeight":"42px","borderStyle":"solid","height":"42px"}' type="button" class="layui-btn btn-theme" id="touxiangUpload">
								<i :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="layui-icon">&#xe67c;</i>上传图片
							</button>
						</div>
						<div :style='{"width":"100%","margin":"20px 0 20px 150px","alignItems":"center","textAlign":"center","display":"flex"}' class="layui-form-item">
							<button :style='{"cursor":"pointer","padding":"0px 20px","margin":"0 20px 0 0","borderColor":"#59B450","color":"#fff","minWidth":"130px","outline":"none","borderRadius":"30px","background":"#40a8c4","borderWidth":"0","width":"auto","fontSize":"14px","lineHeight":"44px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit btn-theme" lay-submit lay-filter="*">更新信息</button>
							<button :style='{"cursor":"pointer","padding":"0px 20px","margin":"0 10px","borderColor":"#999","color":"#fff","minWidth":"130px","outline":"none","borderRadius":"30px","background":"#f7aa00","borderWidth":"0","width":"auto","fontSize":"14px","lineHeight":"44px","borderStyle":"solid","height":"44px"}' @click="logout" class="layui-btn btn-submit">退出登录</button>
						</div>
					</form>
				</div>
				<!-- 个人中心 -->
