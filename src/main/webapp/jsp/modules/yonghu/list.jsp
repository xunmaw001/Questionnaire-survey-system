	...
	<div id="main-container">
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('用户性别统计')"><i class="fa fa-database"></i><span>用户性别统计</span></button>
			</div>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="xingbieMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('xingbieMain1'),'macarons');
                                    var option = {};
                                    option = {
                                            title: {
                                                text: '用户性别统计',
