...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">问卷调查管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>问卷调查管理</span></li>
				<li class="breadcrumb-item-two"><span>问卷调查列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('问卷类型统计')"><i class="fa fa-database"></i><span>问卷类型统计</span></button>
			</div>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="leixingMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('leixingMain1'),'macarons');
                                    var option = {};
                                    option = {
                                        title: {
                                            text: '问卷类型统计',
